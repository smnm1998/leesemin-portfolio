...
const styles = {
    ...
    description:
        "text-center text-gray-500 dark:text-gray-300 text-base leading-relaxed",
    scrollBtn:
        ...
        <div className={styles.wrapper}>
            ...
            <div className="flex flex-col items-center gap-6">
                <p className={styles.description}>
                    <i className="text-2xl text-gray-700 dark:text-gray-100">
                        소통, 책임, 신뢰
                    </i>
                    <br />
                    <br />
                    적극적이고 원활한 소통, 자신이 맡은 업무에 대한 책임감
                    그리고 팀원에 대한 신뢰가 중요하다 생각합니다.
                </p>
                <motion.button
